        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{url('admin/post-gift/')}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name='gift_code' placeholder="Write Code...."> 
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  <div class="col-sm-10">
                      <input type="submit" value="Submit New Gift" class='btn btn-success'>
                  </div>
                </div>
